...
export const HeroCards = () => {
  return (
    <div className="hidden lg:flex flex-row flex-wrap gap-8 relative w-[700px] h-[500px] ml-[-90px]">
      {/* Testimonial */}
      <Card className="absolute w-[340px] -top-[15px] drop-shadow-xl ms-[50px] shadow-black/10 dark:shadow-white/10">
  ...
  <CardContent>
    Our software solutions are built with scalability in mind, ensuring your systems grow seamlessly with your business.
      ...
      {/* Team Member */}
      <Card className="absolute right-[20px] top-[-9px] w-80 flex flex-col justify-center items-center drop-shadow-xl shadow-black/10 dark:shadow-white/10">
  ...
  <CardFooter>
    <div>
      ...
      {/* Service */}
      <Card className="absolute top-[150px] left-[50px] w-72 mt-4 drop-shadow-xl shadow-black/10 dark:shadow-white/10">
     ...
     {/* Service */}
{/* <Card className="absolute top-[300px] left-[300px] w-72 drop-shadow-xl shadow-black/10 dark:shadow-white/10 mt-[60px]">
  <CardHeader className="space-y-1 flex md:flex-row justify-start items-start gap-4">
    <div className="mt-1 bg-primary/20 p-1 rounded-2xl">
  ...
  <CardDescription className="text-md mt-9">
    Our team rigorously tests each product, ensuring optimal functionality and performance across all platforms.
  </CardDescription>
</div>
