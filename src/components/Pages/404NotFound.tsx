...
const NotFound = () => {
  ...
  <StyledWrapper className="flex items-center justify-center h-screen w-full overflow-hidden">
  ...
  {/* Button Section */}
  <div className="flex justify-center mt-[-129px]">
    <button className="px-6 py-3 bg-indigo-600 text-white font-bold rounded-lg hover:bg-indigo-500 transition duration-300">
      Go Back Home
    </button>
  </div>
</>
...
.screen_out1 {
  ...
  z-index: 1; /* Lower priority than the navbar */
  overflow: hidden; /* Contain the overflowing content */
}

.notfound_text {
  font-size: 1.5rem; /* Adjust size to fit within the screen */
  text-align: center;
...
.navbar {
  ...
  z-index: 10; /* Higher priority to ensure it overlaps other elements */
}
